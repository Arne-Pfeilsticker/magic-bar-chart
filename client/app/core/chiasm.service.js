(function (appCore) {
    ...
    appCore.factory('chiasmService', chiasmService);

    //chiasmService.$inject = ['chiasm', 'ChiasmLayout', 'ChiasmLinks', 'ChiasmDsvDataset', 'ChiasmDataReduction'];
    //function chiasmService(Chiasm, ChiasmLayout, ChiasmLinks, ChiasmDsvDataset, ChiasmDataReduction) {
